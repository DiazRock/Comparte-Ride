...
class Circle(CRideModel):
    ...
    by its members. To join to a circle a user must recieve an unique
    ...
    verified = models.BooleanField (
        'verified circle',
        default= False,
        help_text= 'Verfified circle are also known as official communities.'
    )
    
    is_public = models.BooleanField (
        default= True,
        help_text = 'Public circles are listed in the main page se everyone know about their existence.'
    )
